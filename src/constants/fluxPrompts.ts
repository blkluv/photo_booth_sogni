...
export const FLUX_KONTEXT_PROMPTS = {
  ...
  makeMeBodybuilder: "Give the person huge muscles while keeping their identity and everything else the same",
  ...
  makeMeCowboyOutfit: "Replace their clothes with a cowboy outfit while keeping everything else about them and the scene the same. Put a horse behind them.",
  ...
  makeMeTinyDeskGremlin: "Shrink the person to toy size on a cluttered desk keep identity macro depth of field giant coffee mug and paper clips",
  makeMeUFOAbduction: "Place the person under a tractor beam from a UFO keep identity floating pose dust and light rays rural night background",
  ...
  makeMeSimpsonsInspired: "Convert into a cartoon look inspired by The Simpsons keep identity yellow skin tone bold lines and a suburban interior, keep their face and identity the same",
  ...
  makeMeMinecraftInspired: "Voxelize the person and the scene inspired by Minecraft keep identity squared features blocky environment and simple sky",
  makeMeWoWInspired: "Style the person as a fantasy hero inspired by a classic online world keep identity ornate armor glowing runes and castle hall",
  makeMeZeldaInspired: "Convert them into a heroic adventurer inspired by a legendary green tunic saga while keeping their identity the same, cel shaded look forest temple background",
  ...
  makeMeMTVUnpluggedStage: "Place the person on an acoustic stage keep identity smoky lights stool guitar and soft spotlight",
